                      ...
                      <tr v-for="(permission, index) in permissions.data" :key="index">
                        ...
                        <td class="text-right"
                          ...
                          <button class="btn btn-success text-uppercase" style="letter-spacing: 0.1em;"
                            @click="editModal(permission)">Edit</button>
                          <button class="btn btn-danger text-uppercase ml-1" style="letter-spacing: 0.1em;"
                            @click="deletePermission(permission)">Delete</button>
                        </td>
                      </tr>
                    </tbody>
                  </table>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body overflow-hidden">
              <p class="h6 text-warning">** All permission must start with "create: ", "read: ", "update: ", or "delete:
                "</p>
                ...
                <form @submit.prevent="checkMode">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="permission" placeholder="Permission Name"
                        v-model="form.name" :class="{ 'is-invalid': form.errors.name }" autofocus="autofocus"
                        autocomplete="off">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="description" placeholder="Permission Description"
                  ...
                  <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" class="btn btn-info text-uppercase" style="letter-spacing: 0.1em;"
                      :disabled="!form.name || !form.description || form.processing">{{ buttonTxt }}</button>
                  </div>
                </form>
              </div>
            </div>
